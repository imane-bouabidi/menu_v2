                            ...
                            <div class="col-lg-6 ">
                                <div class="footer-flex-box">
                                    <div class="footer-table-info">
                                        ...
                                        <ul>
                                            <li><i class="uil uil-clock"></i> Mon-Sun : {{$restaurant->opening_hour}} - {{$restaurant->closing_hour}}</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <div class="copyright-text">
                                <p>Copyright &copy; 2021 <span class="name">{{$restaurant->name}}</span>All Rights Reserved.
                                </p>
                            </div>
                        </div>
                    </div>
